...
var buf = [];
buf.push("<div class=\"step-section\"><h3>What's the url you want to share?</h3><input type=\"text\" placeholder=\"http://\"/><br/></div><div class=\"step-section last-bottom\"><h3>What is your link about?</h3><textarea></textarea><div class=\"character-counter helper-tag\">0</div><div class=\"twitter-warning helper-tag\">Twiter max reached!</div><div class=\"cl\"></div></div>");;return buf.join("");
};
